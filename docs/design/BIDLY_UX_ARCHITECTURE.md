...
| Public information | `/business-info`, `/about`, `/support`, `/legal/*`                                                                                                                                                        | Explain the platform, supplier proposition and published documents without exposing operational data. | Static truth-only content; legal texts require approved source material.                      |
...
The public explanatory journey has seven human stages; it must not expose internal reverse-auction vocabulary or pretend that a data-free catalogue entry is an active pool.
